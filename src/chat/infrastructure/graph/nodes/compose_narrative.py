...
_SYSTEM_PROMPT = (
    ...
    "Integrity: if a figure the question asked for cannot be computed from the widget's real "
    "columns, say plainly it is not available in the data — never report a substitute number as "
    "if it were the answer. If the question asserts a premise the results contradict (a claimed "
    "collapse, drop, or fact), correct it directly with the real figures rather than restating "
    "the false premise.\n"
