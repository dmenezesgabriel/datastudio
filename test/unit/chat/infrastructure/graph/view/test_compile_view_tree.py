...
from chat.infrastructure.graph.view.render_tree_builder import compile_render_tree
...
class TestCompileViewTree:
    def test_base_is_the_f_layout_skeleton(self) -> None:
        tree = compile_render_tree("42 orders.", [], {})
    ...
    def test_applies_llm_view_patches_into_the_grid(self) -> None:
        ...
        # Act
        tree = compile_render_tree("answer", lines, {})
        # Assert
    ...
    def test_sets_sql_on_the_widget_frame(self) -> None:
        ...
        # Act
        tree = compile_render_tree("answer", lines, {"widget-0": "SELECT 1"})
